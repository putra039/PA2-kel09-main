                                                    ...
                                                    <tr class="white-space-no-wrap">
                                                        <td class="pr-0 ">
                                                            <div
                                                                class="custom-control custom-checkbox custom-control-inline">
                                                                <input type="checkbox" class="custom-control-input m-0"
                                                                    id="customCheck" value="{{ $pengajuan->user_id }}">
                                                                <label class="custom-control-label"
                                                        ...
                                                        <td class="">
                                                            <div class="active-project-1 d-flex align-items-center mt-0 ">
                                                                <div class="data-content">
                                                                    <div>
                                                                        <a href="{{ route('update-pengajuan', $pengajuan->user_id) }}"
                                                                            class="font-weight-bold">{{ $pengajuan->user_name }}</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex justify-content-end align-items-center">
                                                                ...
                                                                <a class="" data-toggle="tooltip"
                                                                    ...
                                                                    onclick="redirectToPengajuanUpdate({{ $pengajuan->id }})">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                ...
                                                                <a class="badge bg-danger" data-toggle="tooltip"
                                                                    ...
                                                                    onclick="event.preventDefault(); if(confirm('Are you sure you want to delete this?')){ deletePengajuan({{ $pengajuan->id }}); }">
...
@section('scripts')
    ...
    <script>
        function redirectToPengajuanUpdate(pengajuanId) {
            window.location.href = "{{ route('pengajuan.update', ':id') }}".replace(':id', pengajuanId);
        }
    </script>
@endsection
